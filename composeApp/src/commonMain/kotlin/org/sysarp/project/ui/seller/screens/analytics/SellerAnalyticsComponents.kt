...
/**
 * Componente para mostrar las métricas principales del vendedor
 */
@Composable
fun SellerPrimaryMetricsSection(
            ...
            Row(
                ...
                Column(
                    ...
                    Row(
                        ...
                        // Indicador de tendencia (simplificado)
                        Row(
                            verticalAlignment = Alignment.CenterVertically,
                ...
                // Lado derecho: Métricas secundarias en layout compacto
                Column(
                    ...
                    Card(
                        ...
                        Column(
                            ...
                            Text(
                                text = formatCurrency(data.averageTransactionValue),
...
/**
 * Componente para mostrar métricas adicionales del vendedor
 */
@Composable
fun SellerAdditionalMetricsCard(
    data: AnalyticsOverview,
    modifier: Modifier = Modifier
) {
    Card(
