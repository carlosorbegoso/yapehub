    ...
    androidx.compose.ui.window.Dialog(
        ...
        Card(
            ...
            Column(
                ...
                Text(
                    text = "Selecciona qué secciones mostrar en el dashboard",
                    style = MaterialTheme.typography.bodyMedium,
                    color = MaterialTheme.colorScheme.onSurfaceVariant
                )
                
                // Filtro de gráficos básicos
                Row(
                    modifier = Modifier.fillMaxWidth(),
                    ...
                    Column(modifier = Modifier.weight(1f)) {
                        ...
                        Text(
                            text = "Ventas diarias, métricas de rendimiento y tendencias",
                ...
                Row(
                    ...
                    Column(modifier = Modifier.weight(1f)) {
                        ...
                        Text(
                            text = "Ventas por hora, distribución y logros",
                            style = MaterialTheme.typography.bodySmall,
                            color = MaterialTheme.colorScheme.onSurfaceVariant
                        )
                    }
                ...
                Row(
                    ...
                    Column(modifier = Modifier.weight(1f)) {
                        ...
                        Text(
                            text = "Predicciones y comparaciones",
                            style = MaterialTheme.typography.bodySmall,
                            color = MaterialTheme.colorScheme.onSurfaceVariant
                        )
                    }
