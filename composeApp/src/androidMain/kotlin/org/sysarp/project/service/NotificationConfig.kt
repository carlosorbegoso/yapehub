...
/**
 * Configuración para el manejo seguro de notificaciones
 */
object NotificationConfig {
    ...
    /**
     * Verifica si las notificaciones están habilitadas y configuradas correctamente
     */
    fun isNotificationServiceEnabled(context: Context): Boolean {
        return try {
            ...
            Log.d(TAG, "Servicio de notificaciones encontrado: ${serviceInfo != null}")
            serviceInfo != null
        } catch (e: Exception) {
     ...
     */
    fun initializeNotificationService(context: Context): Boolean {
        return try {
     ...
     */
    fun isYapeNotification(packageName: String, title: String, text: String): Boolean {
        return try {
